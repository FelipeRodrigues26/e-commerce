...
"./OrdersApp":()=>{
      ...
      return __federation_import('./__federation_expose_OrdersApp-CyTBD7It.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
