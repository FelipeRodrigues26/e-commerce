...
"./CatalogApp":()=>{
      ...
      return __federation_import('./__federation_expose_CatalogApp-d6f9f766.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
